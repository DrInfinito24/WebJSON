...
function formEntry(fullName,email,phoneNumber,outside,children,childrenAge,otherPet,otherPetName){
    return
}
...
document.getElementById("submit").addEventListener("click", function (event) {
    ...
    formEntry(document.getElementById("fullname").value,document.getElementById("email").value,document.getElementById("phone").value)
});
